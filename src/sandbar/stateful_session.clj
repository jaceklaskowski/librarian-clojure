...
;; Note from Konrad Garus on librarian-clojure:
;;
;; At the time of this writing sandbar has not been updated for a while 
;; and has many deprecated dependencies that break if used with any newer 
;; libraries.
;;
;; While we value certain sides of sandbar, it is too much of a framework and
;; extracting a single namespace is the most straightforward way to get the
;; library we really need.
