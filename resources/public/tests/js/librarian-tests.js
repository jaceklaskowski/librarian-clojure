...
cljs.core._with_meta["function"] = function(a, b) {
  return cljs.core.with_meta.call(null, function() {
    if(void 0 === cljs.core.t6224) {
      cljs.core.t6224 = {};
      cljs.core.t6224 = function(a, b, c) {
        this.meta = a;
        this.f = b;
        this.meta6225 = c;
      ...
      cljs.core.t6224.cljs$lang$type = !0;
      cljs.core.t6224.cljs$lang$ctorPrSeq = function() {
        return cljs.core.list.call(null, "cljs.core/t6224")
      };
      cljs.core.t6224.cljs$lang$ctorPrWriter = function(a, b) {
        return cljs.core._write.call(null, b, "cljs.core/t6224")
      };
      var c = cljs.core.t6224.prototype, d = function(a, b) {
      ...
      c.call = e;
      cljs.core.t6224.prototype.apply = function(a, b) {
        a = this;
        return a.call.apply(a, [a].concat(b.slice()))
      };
      cljs.core.t6224.prototype.cljs$core$Fn$ = !0;
      cljs.core.t6224.prototype.cljs$core$IMeta$_meta$arity$1 = function() {
        return this.meta6225
      };
      cljs.core.t6224.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = function(a, b) {
        return new cljs.core.t6224(this.meta, this.f, b)
      }
    }
    return new cljs.core.t6224(b, a, null)
  }(), b)
};
...
var librarian_clojure = {frontend:{}};
librarian_clojure.frontend.hello = function(a) {
  return alert([cljs.core.str("Hello "), cljs.core.str(a), cljs.core.str("!")].join(""))
};
librarian_clojure.frontend.adder = function(a, b) {
  return a + b
};
librarian_clojure.frontend.create_button = function() {
  var a = function(a) {
    var a = cljs.core.seq_QMARK_.call(null, a) ? cljs.core.apply.call(null, cljs.core.hash_map, a) : a, a = cljs.core._lookup.call(null, a, "\ufdd0'button-class", null), b = jayq.core.$.call(null, "<button>");
    cljs.core.truth_(a) && b.addClass(cljs.core.name.call(null, a));
    return b
  }, b = function(b) {
    var d = null;
    goog.isDef(b) && (d = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0), 0));
...
librarian_clojure.test = {};
librarian_clojure.test.frontend = {};
librarian_clojure.test.frontend.jqdom = function(a) {
  return a.get(0)
};
librarian_clojure.test.frontend.jqdom_EQ_ = function(a, b) {
  return librarian_clojure.test.frontend.jqdom.call(null, a).isEqualNode(librarian_clojure.test.frontend.jqdom.call(null, b))
};
test("(create-button) returns an empty button", function() {
  return ok(librarian_clojure.test.frontend.jqdom_EQ_.call(null, librarian_clojure.frontend.create_button.call(null), jayq.core.$.call(null, "<button>")), "Should return empty button")
});
test("(create-button :class :foo) returns button with class foo", function() {
  var a = librarian_clojure.test.frontend.jqdom.call(null, librarian_clojure.frontend.create_button.call(null, "\ufdd0'button-class", "\ufdd0'foo"));
  ok("BUTTON" === a.tagName, "This is not a button!");
  return ok("foo" === a.className, "Button does not have class foo!")
});
